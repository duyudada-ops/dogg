...
export const dogPhotos: DogPhoto[] = [
  ...
  { src: '/dog-profiles/dog04.jpg', alt: 'Wet black labrador in a kayak', vibe: 'swimming' },
  ...
  { src: '/dog-profiles/dog11.jpg', alt: 'Curious puppy sniffing flowers', vibe: 'cute' },
  { src: '/dog-profiles/dog12.jpg', alt: 'Dog relaxing on a sofa', vibe: 'normal' },
  { src: '/dog-profiles/dog13.jpg', alt: 'Dog standing in a snowy landscape', vibe: 'normal' },
  { src: '/dog-profiles/dog14.jpg', alt: 'Golden dog playing with a stick', vibe: 'playing' },
  { src: '/dog-profiles/dog15.jpg', alt: 'Close‑up of dog ears in a meadow', vibe: 'cute' },
  { src: '/dog-profiles/dog16.jpg', alt: 'Dog running on the beach', vibe: 'playing' },
  { src: '/dog-profiles/dog17.jpg', alt: 'Puppy sticking its tongue out', vibe: 'cute' },
  { src: '/dog-profiles/dog18.jpg', alt: 'Dog with heterochromia eyes', vibe: 'show' },
  { src: '/dog-profiles/dog19.jpg', alt: 'Dog enjoying a car ride', vibe: 'normal' },
  ...
  { src: '/dog-profiles/dog22.jpg', alt: 'Happy dog at the park', vibe: 'normal' },
  { src: '/dog-profiles/dog23.jpg', alt: 'Puppy staring at a butterfly', vibe: 'cute' },
  { src: '/dog-profiles/dog24.jpg', alt: 'Dog resting under a tree', vibe: 'sleeping' },
  { src: '/dog-profiles/dog25.jpg', alt: 'Puppy and flower garden backdrop', vibe: 'cute' },
  { src: '/dog-profiles/dog26.jpg', alt: 'Dog silhouette at sunset', vibe: 'normal' },
  { src: '/dog-profiles/dog27.jpg', alt: 'Dog exploring a hiking trail', vibe: 'playing' },
  { src: '/dog-profiles/dog28.jpg', alt: 'Dog rolling in the grass', vibe: 'playing' },
  { src: '/dog-profiles/dog29.jpg', alt: 'Puppy playing with a ball', vibe: 'playing' },
  { src: '/dog-profiles/dog30.jpg', alt: 'Dog waiting by the door', vibe: 'normal' },
  { src: '/dog-profiles/dog31.jpg', alt: 'Dog running through leaves', vibe: 'playing' },
  { src: '/dog-profiles/dog32.jpg', alt: 'Dog with a red collar', vibe: 'normal' },
  { src: '/dog-profiles/dog33.jpg', alt: 'Puppy standing in a puddle', vibe: 'cute' },
  { src: '/dog-profiles/dog34.jpg', alt: 'Dog looking up at the sky', vibe: 'normal' },
  { src: '/dog-profiles/dog35.jpg', alt: 'Fluffy puppy yawning', vibe: 'cute' },
  { src: '/dog-profiles/dog36.jpg', alt: 'Dog posing with sunglasses', vibe: 'sunglasses' },
  ...
  { src: '/dog-profiles/dog39.jpg', alt: 'Dog enjoying a sunny day', vibe: 'normal' },
